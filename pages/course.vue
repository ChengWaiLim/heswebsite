<template>
  <section>
    <Header></Header>
    <TitleSlide :titleSlide="titleSlide"></TitleSlide>
            ...
            <div class="blog_left_sidebar">
              <article class="blog_item">
                <div class="blog_item_img">
                  <img class="card-img rounded-0" src="@/assets/image1.jpg" alt />
...
import TitleSlideData from "~/components/TitleSlide/Interface";
